...
public class ReversiModel implements GameModel {
	...
	public ReversiModel() {
		...
		// Insert the cursor in the middle of the gameboard.
	...
	private void tryPlay() {
		if (isPositionEmpty(this.cursorPos)) {
			if (canTurn(this.turn, this.cursorPos)) {
				...
				changeSup.firePropertyChange("nextTurn", this.turn, Turn.nextTurn(this.turn));
	...
	public void gameUpdate(final int lastKey) throws GameOverException {
		if (!this.gameOver) {
			...
			changeSup.firePropertyChange("cursorChanged", this.cursorPos, nextCursorPos);
	...
	public void addObserver(PropertyChangeListener observer) {
		changeSup.addPropertyChangeListener(observer);
	}

	@Override
	public void removeObserver(PropertyChangeListener observer) {
		changeSup.removePropertyChangeListener(observer);
	}
